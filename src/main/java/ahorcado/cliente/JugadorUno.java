...
public class JugadorUno {
    ...
    public static void main(String[] args){
        ...
        //jugadorUno.realizarRegistroCliente();

        // Nos logueamos/deslogueamos con el usuario existente
        String token = jugadorUno.realizarLoginCliente();
        //jugadorUno.realizarLogoutCliente();
        /* ----------- */
        ...
        //jugadorUno.comenzarNuevaPartida(token);

        jugadorUno.comenzarNuevaPartidaMultijugador(token);
        /* ----------- */
    }
    ...
    public void comenzarNuevaPartidaMultijugador(String token){
        ...
        JSONObject datosPeticion = new JSONObject();
        datosPeticion.put("metodo", Metodo.POST.name());
        datosPeticion.put("accion", "crearPartidaMultijugador");
        datosPeticion.put("args", args);
